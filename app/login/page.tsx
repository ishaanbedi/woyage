  ...
  if (user) {
    ...
    return (
      <section className="flex h-[92vh] items-center justify-evenly bg-background">
        ...
        <div>
          <img src="https://illustrations.popsy.co/white/keynote-presentation.svg" className="w-96 h-96 my-auto" alt="" />
        </div>
        <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2">
          ...
          <div className="   p-5 rounded-lg border bg-card text-card-foreground shadow-sm w-96 mx-auto overflow-hidden">
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Contact us at hey@ishaanbedi.com and we will send you a link to reset your password.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
