const Terms = () => {
  ...
  return (
    <div className="terms-page prose max-w-xl px-2 mx-auto py-3">
      <h1>Supalytics Terms of Service</h1>
      <p>
        Please note that Supalytics is a project created by indie developers and
        is not affiliated in any way with any other company or service.
      </p>
      <p>
        Welcome to Supalytics! These terms govern your use of Supalytics and any
        related services provided by Supalytics.
      </p>
      <h2>1. Acceptance of Terms</h2>
      <p>
        By accessing or using Supalytics, you agree to be bound by these terms
        of service. If you do not agree to these terms, please do not use
        Supalytics.
      </p>
      <h2>2. Description of Service</h2>
      <p>
        Supalytics provides analytics services for websites and applications,
        allowing users to track and analyze traffic to their websites.
      </p>
      <h2>3. Privacy Policy</h2>
      <p>
        Your use of Supalytics is also subject to our Privacy Policy, which
      ...
      <p>
        ...
        continued use of Supalytics after any such changes constitutes your
        acceptance of the new terms.
      </p>
      <h2>5. Limitation of Liability</h2>
      <p>
        Supalytics and its developers and contributors will not be liable for
        ...
        of or inability to use Supalytics.
      </p>
      <h2>6. Indemnity</h2>
      <p>
        You agree to indemnify and hold harmless Supalytics and its developers
        and contributors from and against any and all claims and expenses,
        including attorneys' fees, arising out of your use of Supalytics,
      ...
      <p>
        ...
        requirement, protect the rights, property, or safety of Supalytics or
        others, or prevent illegal activity.
      </p>
      <h2>8. Termination</h2>
      <p>
        We reserve the right to terminate or suspend your account and access to
        Supalytics at any time, with or without notice. A valid reason for such
        a termination would be provided.
      </p>
      <h2>9. What counts as a breach of terms?</h2>
      <p>
        A breach of terms would be considered if you use Supalytics for any
        illegal or unauthorized purpose, or violate any laws in your
        jurisdiction.
      </p>
      <h2>10. Payment & Expenses</h2>
      <p>
        Supalytics is a free service and does not require any payment. However,
        we reserve the right to introduce paid features in the future.
        <br />
        As of {lastUpdated}, Supalytics is a free service and does not require
        any payment at all.
      </p>
      <h2>11. Copyright and Intellectual Property</h2>
      <p>
        All content on Supalytics, including but not limited to text, graphics,
        logos, icons, images, audio clips, digital downloads, data compilations,
        and software, is either owned by Supalytics or sourced from the public
      ...
      <p>
        ...
        <br />I am an indie developer and I created Supalytics as a side
        project. Please let me know if something more needs to be added to this
        in order to make it more clear and safe and secure for everyone.
      </p>
